...
# -A INPUT -s vpn.ip.range.0/255.255.255.0 -p tcp -m state --state NEW -m tcp --dport 22 -j ACCEPT
-A INPUT -s 10.100.21.0/255.255.255.0 -m state --state NEW -m tcp -p tcp --dport
 22 -j ACCEPT
