...
host    all             all             130.56.85.0/24         md5
...
grant ALL on schema public to gislibrary;
GRANT ALL ON ALL TABLES IN SCHEMA public TO gislibrary;
grant ALL on all functions in schema public to gislibrary;
grant ALL on all sequences in schema public to gislibrary;
