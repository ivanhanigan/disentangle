...
*** COMMENT rpart_deviance_explained-code
#+name:rpart_deviance_explained
#+begin_src R :session *R* :tangle R/rpart_deviance_explained.r :exports none :eval no
  ################################################################
  # name:rpart_deviance_explained
...
#+end_src
*** COMMENT rpart_deviance_explained-test-code
#+name:rpart_deviance_explained-test
#+begin_src R :session *R* :tangle src/rpart_deviance_explained-test.r :exports none :eval no
  ################################################################
  # name:rpart_deviance_explained-test
