...
#+begin_src R :session *R* :tangle ~/projects/ivanhanigan.github.com.raw/_drafts/2013-10-13-dc-uploader-and-ANU-DataCommons.md :exports none :eval no :padline no
  ---
  ...
  <p></p>
  # go to the website
  Go to [the dev site](https://dc7-dev2.anu.edu.au:8443/DataCommons/) or if using the production server go to [This Link](https://datacommons.anu.edu.au:8443/DataCommons)
  This has created a new record in our account.
  
  Looking at metadata.txt it has been modified with the new pid.
  
  # Error encountered on dev environment
