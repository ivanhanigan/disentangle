...
#+begin_src R :session *R* :tangle ~/projects/ivanhanigan.github.com.raw/_drafts/two-main-types-of-data-documentation-workflow.md :exports none :eval no :padline no
  ---
  ...
  #### Code: 
      ...
      # load
      fpath <- system.file(file.path("extdata", "civst_gend_sector_full.csv"),
                           package = "disentangle"
                           )
...
#+begin_src R :session *R* :tangle ~/projects/ivanhanigan.github.com.raw/_drafts/data-documentation-case-study-reml-and-rfigshare.md :exports reports :eval no 
---
name: two-main-types-of-data-documentation-workflow
layout: post
title: two-main-types-of-data-documentation-workflow
