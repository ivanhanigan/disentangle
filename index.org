...
#+end_src
** 2013-10-11-reml-and-rfigshare-part-2
#+name:reml-and-rfigshare-part-2-header
#+begin_src R :session *R* :tangle ~/projects/ivanhanigan.github.com.raw/_drafts/2013-10-11-reml-and-rfigshare-part-2.md :exports reports :eval no :padline no
  ---
  ...
  #### Code:reml-and-rfigshare-part-2
      ...
      fpath <- "inst/extdata/civst_gend_sector_eml.xml"
      obj <- eml_read(fpath)
      # clean
      obj
      # do
      id <- eml_publish(fpath,
      ...
      ## Your article has been created! Your id number is 820129
      ## text_content() deprecated. Use parsed_content(x, as = 'parsed')
      ## text_content() deprecated. Use parsed_content(x, as = 'parsed')
      ## Error in fs_cat_to_id(category_id) (from fs_add_categories.R#55) : 
      ##   One or more of your input strings is not a valid category
