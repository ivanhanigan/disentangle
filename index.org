...
*** R-R-spss_summary
#+name:R-spss_summary
#+begin_src R :session *R* :tangle R/spss_summary.r :exports none :eval no
  # name:spss_summary
...
#+begin_src R :session *R* :tangle no :exports none :eval no
  ...
  for(i in 1:ncol(civst_gend_sector)){
  out2 <- spss_summary(civst_gend_sector, names(civst_gend_sector)[i])
  out <- rbind(out, out2)
  }
  out
