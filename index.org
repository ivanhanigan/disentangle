...
*** R-bounding_box
#+name:bounding_box
#+begin_src R :session *R* :tangle R/bounding_box.r :exports none :eval no
################################################################
# name:bounding_box
...
*** test-bounding_box
#+name:bounding_box
#+begin_src R :session *R* :tangle tests/test-bounding_box.r :exports none :eval no
  ################################################################
  # name:bounding_box
  if (!require(rgdal)) install.packages('rgdal'); require(rgdal)
  epsg <- make_EPSG()
  ...
  # morpho report
  # only for southern hemisphere, east of GMT?
