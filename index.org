...
#+begin_src R :session *R* :tangle :eval no :exports reports :padline no
    ...
    #### R Code:
        ...
        write.csv(data_set, "data/civst_gend_sector_full.csv")
...
#+begin_src R :session *R* :tangle no :exports reports :eval no
  ...
  reml_boilerplate(
    data_set = analyte
    ,
    metadata_creator = "Ivan Hanigan <ivanhanigan@gmail.com>"
    ,
    data_dir = "data"
    ,
    titl = NA
...
** blog-morpho-and-reml-boilerplate-streamline-the-process-of-metadata-entry
...
<pre class="src src-R">  <span style="color: #586e75;">#### </span><span style="color: #586e75;">R Code:</span>
      ...
      write.csv(data_set, <span style="color: #2aa198;">"data/civst_gend_sector_full.csv"</span>)
...
<span style="color: #586e75;"># </span><span style="color: #586e75;">name:reml_boilerplate</span>
  ...
  <span style="color: #586e75;">#### </span><span style="color: #586e75;">R Code:</span>
      <span style="color: #586e75;"># </span><span style="color: #586e75;">func</span>
      <span style="color: #268bd2; font-weight: bold;">require</span>(devtools)
  ...
  reml_boilerplate <span style="color: #268bd2; font-weight: bold;">&lt;-</span> (data_set, metadata_creator = <span style="color: #2aa198;">"Ivan Hanigan &lt;<a href="mailto:ivanhanigan&#64;gmail.com">ivanhanigan&#64;gmail.com</a>&gt;"</span>, data_dir = getwd(), titl = <span style="color: #b58900;">NA</span>,
                       desc = <span style="color: #2aa198;">""</span>)
  {
...
reml_boilerplate(
  data_set = analyte
  ,
  metadata_creator = <span style="color: #2aa198;">"Ivan Hanigan &lt;<a href="mailto:ivanhanigan&#64;gmail.com">ivanhanigan&#64;gmail.com</a>&gt;"</span>
  ,
  data_dir = <span style="color: #2aa198;">"data"</span>
  ,
  titl = <span style="color: #b58900;">NA</span>
  ,
...
<h4 id="sec-1-12"><span class="section-number-4">1.12</span> Conclusions</h4>
