...
#+begin_src R :session *R* :tangle src/rpart_deviance_explained.r :exports none :eval no
  ################################################################
  # name:rpart_deviance_explained
  # explanatory power
  require(devtools)
  ...
  fpath
  estat <- print(fit)$frame[,c("var","n","dev","yval")]
  str(estat)
  (estat[1,"dev"] - sum(subset(estat, var == "<leaf>")$dev)) / estat[1,"dev"]
