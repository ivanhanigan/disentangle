...
#+begin_src R :session *R* :tangle tests/test-levenshtein.r :exports none :eval no
  ...
  textin  <- read.csv(textConnection("curse
Aardvark! 
Abecedarians! 
Aborigine! 
