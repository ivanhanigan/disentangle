...
#### 1 Use a good code editor
I like ysing Emacs with Orgmode.
...
- link to the great orgmode post
- this guy spends a lot of time on tweaking his set up

#### 2 Analyse data with Scripts
I use Scripts but prefer to think of them as stiched together Code Chunks with prose into Compendia.
...
- Here is how I use Emacs to achieve this (the other editors I mentioned above also have the abiltiy to do this too)
...
- To create modular code scripts from these chunks use C-c C-v t
...
#### 3 Store your work simply and document it properly
- this organises code sections into modules, documentation is within the main script
...
- I generally use Dropbox for  basic project management admin stuff
