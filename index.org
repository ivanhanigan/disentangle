...
** 2014-01-21-morpho-and-reml-use-case
#+name:morpho-and-reml-use-case-header
#+begin_src R :session *R* :tangle ~/projects/ivanhanigan.github.com.raw/_posts/2014-01-21-morpho-and-reml-use-case.md :exports none :eval no :padline no
  ---
  name: 2014-01-21-morpho-and-reml-use-case
  layout: post
  title: morpho-and-reml-use-case
  date: 2014-01-21
  categories:
  - Data Documentation
  ---
  ...
  - The (https://github.com/ropensci/EML) uses Ecological Metadata Language (EML) approach that allows archiving of very heterogeneous data without having to standardize everything into a narrow and pre-defined syntax.
  ...
  - The aim of this experiment is to use the EML package to create some advanced metadata as quickly as possible, and use ["boilerplate code"](http://en.wikipedia.org/wiki/Boilerplate_code) wherever possible.
  ...
  - I use the Morpho package for metadata data entry
  - A big reason is because Metacat is a great data portal.
  ...
  - Step two load the data found in the download file from [the "Code for analysing the mulgara experiment" from here](http://www.nceas.ucsb.edu/~mccarthy/research.html)
