...
*** R-causal_diagram
#+name:causal_diagram
#+begin_src R :session *R* :tangle R/causal_diagram.r :exports none :eval no
...
#+RESULTS: causal_diagram

*** test-causal_diagram
#+name:causal_diagram
#+begin_src R :session *R* :tangle tests/test-causal_diagram.r :exports none :eval yes
  # name:causal_diagram
  library(DiagrammeR)
  library(stringr)
