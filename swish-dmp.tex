...
\begin{tikzpicture}[dirtree, every node/.style={font=\footnotesize}] % it's what we defined above
...
\begin{tikzpicture}[
              ...
              >=stealth,
           every node/.append style={align=center}, every node/.append style={font=\footnotesize}]
