...
\node [draw=black!50,dashed,rectangle,fill=green!20]{\textbf{Root directory}}
    child { node {\hyperref[dmp]{DMP} }}
    child { node {\hyperref[datinv]{Data Inventory} }}
    child { node {\hyperref[install]{Project1} }
        child { node {\hyperref[linux]{README}} }
        child { node {\hyperref[mac3]{project management}} }
        child { node {\hyperref[mac]{dataset1}} 
            child { node {\hyperref[mac2]{workplan}} }            
            child { node {\hyperref[mac3]{worklog}} }
            child { node {\hyperref[workflow]{workflow}} }
            child { node {\hyperref[dataprov]{data provided}} }
            child { node {\hyperref[dataprov]{data derived}} 
